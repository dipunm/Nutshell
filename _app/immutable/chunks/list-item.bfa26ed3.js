import{o as F,_ as r,l as K,s as g,x as f,i as y,e as $,A as u}from"./lit-element.c752fa74.js";import{s as q,p as O,n as v,r as _,i as B,d as x,c as H,o as G}from"./form-submitter.bde3f53d.js";/**
 * @license
 ...
 */function z(s,t=p){const e=D(s,t);return e&&(e.tabIndex=0,e.focus()),e}function N(s,t=p){const e=W(s,t);return e&&(e.tabIndex=0,e.focus()),e}function I(s,t=p){for(let e=0;e<s.length;e++){const i=s[e];if(i.tabIndex===0&&t(i))return{item:i,index:e}}return null}function D(s,t=p){for(const e of s)if(t(e))return e;return null}function W(s,t=p){for(let e=s.length-1;e>=0;e--){const i=s[e];if(t(i))return i}return null}function j(s,t,e=p){for(let i=1;i<s.length;i++){const l=(i+t)%s.length,o=s[l];if(e(o))return o}return s[t]?s[t]:null}function X(s,t,e=p){for(let i=1;i<s.length;i++){const l=(t-i+s.length)%s.length,o=s[l];if(e(o))return o}return s[t]?s[t]:null}function k(s,t,e=p){if(t){const i=j(s,t.index,e);return i&&(i.tabIndex=0,i.focus()),i}else return z(s,e)}function E(s,t,e=p){if(t){const i=X(s,t.index,e);return i&&(i.tabIndex=0,i.focus()),i}else return N(s,e)}function Y(){return new Event("request-activation",{bubbles:!0,composed:!0})}function p(s){return!s.disabled}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */const Q=new Set(Object.values(c));class C extends g{get items(){return this.listController.items}constructor(){super(),this.listController=new J({isItem:t=>t.hasAttribute("md-list-item"),getPossibleItems:()=>this.slotItems,isRtl:()=>getComputedStyle(this).direction==="rtl",deactivateItem:t=>{t.tabIndex=-1},activateItem:t=>{t.tabIndex=0},isNavigableKey:t=>Q.has(t),isActivatable:t=>!t.disabled&&t.type!=="text"}),this.internals=O(this,this.attachInternals()),this.internals.role="list",this.addEventListener("keydown",this.listController.handleKeydown)}render(){return f`
    ...
    `}activateNextItem(){return this.listController.activateNextItem()}activatePreviousItem(){return this.listController.activatePreviousItem()}}q(C,{focusable:!1});r([K({flatten:!0})],C.prototype,"slotItems",void 0);/**
  * @license
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class h extends g{constructor(){super(...arguments),this.disabled=!1,this.type="text",this.isListItem=!0,this.href="",this.target=""}get isDisabled(){return this.disabled&&this.type!=="link"}willUpdate(t){this.href&&(this.type="link"),super.willUpdate(t)}render(){return this.renderListItem(f`
      <md-item>
        <div slot="container">
          ${this.renderRipple()}
    ...
    `}onFocus(){this.tabIndex===-1&&this.dispatchEvent(Y())}focus(){var t;(t=this.listItemRoot)==null||t.focus()}}_(h);h.shadowRootOptions={...g.shadowRootOptions,delegatesFocus:!0};r([v({type:Boolean,reflect:!0})],h.prototype,"disabled",void 0);r([v()],h.prototype,"type",void 0);r([v({type:Boolean,attribute:"md-list-item",reflect:!0})],h.prototype,"isListItem",void 0);r([v()],h.prototype,"href",void 0);r([v()],h.prototype,"target",void 0);r([B(".list-item")],h.prototype,"listItemRoot",void 0);/**
  * @license
  * Copyright 2022 Google LLC
  * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let R=class extends h{};R.styles=[st,tt];R=r([$("md-list-item")],R);
