import { g as goto } from "../chunks/navigation.61099afb.js";
import { b as base } from "../chunks/paths.401ec6cb.js";
import { p as page } from "../chunks/stores.aa49f1a6.js";
...
function encodeBase64ToJson(base64String) {
  var jsonString = buffer.Buffer.from(base64urlToBase64(base64String), "base64").toString();
...
function bytesToNumberBE(bytes2) {
  return hexToNumber$1(bytesToHex(bytes2));
}
function bytesToNumberLE(bytes2) {
  if (!u8a$1(bytes2))
    throw new Error("Uint8Array expected");
  return hexToNumber$1(bytesToHex(Uint8Array.from(bytes2).reverse()));
}
...
function deriveKeysetId(keys) {
  ...
  var hash2 = sha256(new TextEncoder().encode(pubkeysConcat));
  return buffer.Buffer.from(hash2).toString("base64").slice(0, 12);
}
function cleanToken(token) {
  ...
  for (var _i = 0, _c = token.token; _i < _c.length; _i++) {
    ...
    if (tokenEntryMap[tokenEntry.mint]) {
      (_a = tokenEntryMap[tokenEntry.mint].proofs).push.apply(_a, __spreadArray$1([], tokenEntry.proofs, true));
      continue;
    }
    tokenEntryMap[tokenEntry.mint] = { mint: tokenEntry.mint, proofs: __spreadArray$1([], tokenEntry.proofs, true) };
  }
  return {
    memo: token === null || token === void 0 ? void 0 : token.memo,
    token: Object.values(tokenEntryMap).map(function(x) {
      return __assign$2(__assign$2({}, x), { proofs: sortProofsById(x.proofs) });
    })
  };
}
    ...
    return __generator$2(this, function(_c) {
      switch (_c.label) {
        case 0:
          ...
          headers = __assign$1(__assign$1({ Accept: "application/json, text/plain, */*" }, body ? { "Content-Type": "application/json" } : void 0), requestHeaders);
          return [4, fetch(endpoint, __assign$1({ body, headers }, options))];
        case 1:
          response = _c.sent();
          if (!!response.ok)
            return [3, 3];
...
function request(options) {
  return __awaiter$2(this, void 0, void 0, function() {
    ...
    return __generator$2(this, function(_a) {
      switch (_a.label) {
        case 0:
          return [4, _request(__assign$1(__assign$1({}, options), globalRequestOptions))];
        case 1:
          response = _a.sent();
...
var CashuMint = (
  ...
  function() {
    ...
    CashuMint2.getInfo = function(mintUrl) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, request({ endpoint: "".concat(mintUrl, "/info") })];
        });
      });
    };
    CashuMint2.prototype.getInfo = function() {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.getInfo(this._mintUrl)];
        });
      });
    };
    CashuMint2.requestMint = function(mintUrl, amount) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, request({ endpoint: "".concat(mintUrl, "/mint?amount=").concat(amount) })];
        });
      });
    };
    CashuMint2.prototype.requestMint = function(amount) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.requestMint(this._mintUrl, amount)];
        });
      });
    };
    CashuMint2.mint = function(mintUrl, payloads, hash2) {
      return __awaiter$1(this, void 0, void 0, function() {
        var data;
        return __generator$1(this, function(_a) {
          switch (_a.label) {
            case 0:
              return [4, request({
                endpoint: "".concat(mintUrl, "/mint?hash=").concat(hash2),
                method: "POST",
    ...
    CashuMint2.prototype.mint = function(payloads, hash2) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.mint(this._mintUrl, payloads, hash2)];
        });
      });
    };
    CashuMint2.getKeys = function(mintUrl, keysetId) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          if (keysetId) {
          ...
          return [2, request({
            endpoint: "".concat(mintUrl, "/keys").concat(keysetId ? "/".concat(keysetId) : "")
          })];
        });
      });
    };
    CashuMint2.prototype.getKeys = function(keysetId) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.getKeys(this._mintUrl, keysetId)];
        });
      });
    };
    CashuMint2.getKeySets = function(mintUrl) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, request({ endpoint: "".concat(mintUrl, "/keysets") })];
        });
      });
    };
    CashuMint2.prototype.getKeySets = function() {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.getKeySets(this._mintUrl)];
        });
      });
    };
    CashuMint2.split = function(mintUrl, splitPayload) {
      return __awaiter$1(this, void 0, void 0, function() {
        var data;
        return __generator$1(this, function(_a) {
          switch (_a.label) {
            case 0:
              return [4, request({
                endpoint: "".concat(mintUrl, "/split"),
                method: "POST",
                requestBody: splitPayload
              })];
            case 1:
              data = _a.sent();
              if (!isObj(data) || !Array.isArray(data === null || data === void 0 ? void 0 : data.fst) || !Array.isArray(data === null || data === void 0 ? void 0 : data.snd)) {
                throw new Error("bad response");
              }
              return [2, data];
          }
    ...
    CashuMint2.prototype.split = function(splitPayload) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.split(this._mintUrl, splitPayload)];
        });
      });
    };
    CashuMint2.melt = function(mintUrl, meltPayload) {
      return __awaiter$1(this, void 0, void 0, function() {
        var data;
        return __generator$1(this, function(_a) {
          switch (_a.label) {
            case 0:
              return [4, request({
                endpoint: "".concat(mintUrl, "/melt"),
                method: "POST",
                requestBody: meltPayload
              })];
            case 1:
              data = _a.sent();
              if (!isObj(data) || typeof (data === null || data === void 0 ? void 0 : data.paid) !== "boolean" || (data === null || data === void 0 ? void 0 : data.preimage) !== null && typeof (data === null || data === void 0 ? void 0 : data.preimage) !== "string") {
                throw new Error("bad response");
              }
              return [2, data];
          }
    ...
    CashuMint2.prototype.melt = function(meltPayload) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.melt(this._mintUrl, meltPayload)];
        });
      });
    };
    CashuMint2.checkFees = function(mintUrl, checkfeesPayload) {
      return __awaiter$1(this, void 0, void 0, function() {
        var data;
        return __generator$1(this, function(_a) {
          switch (_a.label) {
            case 0:
              return [4, request({
                endpoint: "".concat(mintUrl, "/checkfees"),
                method: "POST",
    ...
    CashuMint2.prototype.checkFees = function(checkfeesPayload) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.checkFees(this._mintUrl, checkfeesPayload)];
        });
      });
    };
    CashuMint2.check = function(mintUrl, checkPayload) {
      return __awaiter$1(this, void 0, void 0, function() {
        var data;
        return __generator$1(this, function(_a) {
          switch (_a.label) {
    ...
    CashuMint2.prototype.check = function(checkPayload) {
      return __awaiter$1(this, void 0, void 0, function() {
        return __generator$1(this, function(_a) {
          return [2, CashuMint2.check(this._mintUrl, checkPayload)];
        });
      });
    };
    return CashuMint2;
...
function hashToCurve(secret) {
  var point;
  while (!point) {
    var hash2 = sha256(secret);
    var hashHex = bytesToHex(hash2);
...
const dhke = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  blindMessage,
  constructProofs,
  hashToCurve,
...
var BlindedMessage = (
  /** @class */
  function() {
    function BlindedMessage2(amount, B_) {
      this.amount = amount;
      this.B_ = B_;
    }
...
(function() {
      ...
      return __generator(this, function(_h) {
        switch (_h.label) {
          case 0:
            ...
            if (!!feeReserve)
              return [3, 2];
            return [4, this.getFee(invoice)];
          case 1:
            feeReserve = _h.sent();
            _h.label = 2;
          case 2:
            _b = this.createBlankOutputs(feeReserve), blindedMessages = _b.blindedMessages, secrets = _b.secrets, rs = _b.rs;
            return [4, this.mint.melt(__assign(__assign({}, paymentPayload), { outputs: blindedMessages }))];
          case 3:
            payData = _h.sent();
            _g = {
            ...
            if (!(payData === null || payData === void 0 ? void 0 : payData.change))
              return [3, 5];
            _e = (_d = dhke).constructProofs;
            _f = [payData.change, rs, secrets];
            return [4, this.getKeys(payData.change)];
          case 4:
          ...
          case 6:
            _g.change = _c;
            return [4, this.changedKeys(payData === null || payData === void 0 ? void 0 : payData.change)];
          case 7:
            return [2, (_g.newKeys = _h.sent(), _g)];
        }
      });
    });
  };
  CashuWallet.prototype.getFee = function(invoice) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4, this.mint.checkFees({ pr: invoice })];
          case 1:
            fee = _a.sent().fee;
            return [2, fee];
        }
  ...
  CashuWallet.prototype.payLnInvoiceWithToken = function(invoice, token) {
    ...
    var proofs = decodedToken.token.filter(function(x) {
  ...
  CashuWallet.prototype.receive = function(encodedToken) {
    var _a;
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_c) {
        switch (_c.label) {
          ...
          case 2:
            _c.trys.push([2, 4, , 5]);
            return [4, this.receiveTokenEntry(tokenEntry)];
          case 3:
          ...
          case 6:
            return [2, {
              ...
              tokensWithErrors: tokenEntriesWithError.length ? { token: tokenEntriesWithError } : void 0,
              newKeys
            }];
        }
      });
  ...
  CashuWallet.prototype.receiveTokenEntry = function(tokenEntry) {
    return __awaiter(this, void 0, void 0, function() {
      var proofsWithError, proofs, newKeys, amount, _a, payload, amount1BlindedMessages, amount2BlindedMessages, _b, fst, snd, proofs1, _c, _d, _e, proofs2, _f, _g, _h, _j, error_2;
      return __generator(this, function(_k) {
        switch (_k.label) {
          ...
          case 1:
            ...
            _a = this.createSplitPayload(0, amount, tokenEntry.proofs), payload = _a.payload, amount1BlindedMessages = _a.amount1BlindedMessages, amount2BlindedMessages = _a.amount2BlindedMessages;
            return [4, CashuMint.split(tokenEntry.mint, payload)];
          case 2:
            _b = _k.sent(), fst = _b.fst, snd = _b.snd;
            ...
            return [4, this.getKeys(fst, tokenEntry.mint)];
          case 3:
            proofs1 = _d.apply(_c, _e.concat([_k.sent()]));
            _g = (_f = dhke).constructProofs;
            _h = [
              snd,
              amount2BlindedMessages.rs,
              amount2BlindedMessages.secrets
            ];
            return [4, this.getKeys(snd, tokenEntry.mint)];
          case 4:
            proofs2 = _g.apply(_f, _h.concat([_k.sent()]));
            proofs.push.apply(proofs, __spreadArray(__spreadArray([], proofs1, false), proofs2, false));
            if (!(tokenEntry.mint === this.mint.mintUrl))
              return [3, 6];
            return [4, this.changedKeys(__spreadArray(__spreadArray([], fst || [], true), snd || [], true))];
          case 5:
            _j = _k.sent();
            return [3, 7];
          case 6:
          ...
          case 9:
            return [2, {
              proofs,
              proofsWithError: proofsWithError.length ? proofsWithError : void 0,
              newKeys
            }];
        }
      });
  ...
  CashuWallet.prototype.send = function(amount, proofs) {
    return __awaiter(this, void 0, void 0, function() {
      var amountAvailable, proofsToSend, change, _a, amount1, amount2, _b, payload, amount1BlindedMessages, amount2BlindedMessages, _c, fst, snd, proofs1, _d, _e, _f, proofs2, _g, _h, _j;
      var _k;
      return __generator(this, function(_l) {
        switch (_l.label) {
          case 0:
            ...
            if (!(amount < amountAvailable))
              return [3, 5];
            _a = this.splitReceive(amount, amountAvailable), amount1 = _a.amount1, amount2 = _a.amount2;
            _b = this.createSplitPayload(amount1, amount2, proofsToSend), payload = _b.payload, amount1BlindedMessages = _b.amount1BlindedMessages, amount2BlindedMessages = _b.amount2BlindedMessages;
            return [4, this.mint.split(payload)];
          case 1:
            _c = _l.sent(), fst = _c.fst, snd = _c.snd;
            _e = (_d = dhke).constructProofs;
            _f = [
              fst,
              amount1BlindedMessages.rs,
            ...
            return [4, this.getKeys(fst)];
          case 2:
            proofs1 = _e.apply(_d, _f.concat([_l.sent()]));
            _h = (_g = dhke).constructProofs;
            _j = [
              snd,
              amount2BlindedMessages.rs,
              amount2BlindedMessages.secrets
            ];
            return [4, this.getKeys(snd)];
          case 3:
            proofs2 = _h.apply(_g, _j.concat([_l.sent()]));
            _k = {
              returnChange: __spreadArray(__spreadArray([], proofs1, true), change, true),
              send: proofs2
            };
            return [4, this.changedKeys(__spreadArray(__spreadArray([], fst || [], true), snd || [], true))];
          case 4:
            return [2, (_k.newKeys = _l.sent(), _k)];
          case 5:
            return [2, { returnChange: change, send: proofsToSend }];
        }
      });
    });
  };
  CashuWallet.prototype.requestTokens = function(amount, hash2) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_f) {
        switch (_f.label) {
          case 0:
            _a = this.createRandomBlindedMessages(amount), blindedMessages = _a.blindedMessages, secrets = _a.secrets, rs = _a.rs;
            payloads = { outputs: blindedMessages };
            return [4, this.mint.mint(payloads, hash2)];
          case 1:
            promises = _f.sent().promises;
            _e = {};
            _c = (_b = dhke).constructProofs;
            _d = [promises, rs, secrets];
            return [4, this.getKeys(promises)];
          case 2:
            _e.proofs = _c.apply(_b, _d.concat([_f.sent()]));
            return [4, this.changedKeys(promises)];
          case 3:
            return [2, (_e.newKeys = _f.sent(), _e)];
        }
      });
    });
  };
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!promises.some(function(x) {
              return x.id !== _this.keysetId;
            })) {
              return [2, void 0];
            }
            return [4, this.mint.getKeys()];
          case 2:
            ...
            return [2, keysetId === this.keysetId ? void 0 : maybeNewKeys];
        }
      });
    });
  };
      ...
      return __generator(this, function(_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            if (!(!mint || mint === this.mint.mintUrl))
              return [3, 3];
            return [4, this.mint.getKeys(arr[0].id)];
          case 2:
            _b = _c.sent();
            return [3, 5];
          case 3:
            return [4, CashuMint.getKeys(mint, arr[0].id)];
          case 4:
            _b = _c.sent();
            _c.label = 5;
          case 5:
  ...
  CashuWallet.prototype.createSplitPayload = function(amount1, amount2, proofsToSend) {
    var amount1BlindedMessages = this.createRandomBlindedMessages(amount1);
    var amount2BlindedMessages = this.createRandomBlindedMessages(amount2);
    var allBlindedMessages = [];
    allBlindedMessages.push.apply(allBlindedMessages, amount1BlindedMessages.blindedMessages);
    allBlindedMessages.push.apply(allBlindedMessages, amount2BlindedMessages.blindedMessages);
    var payload = {
      proofs: proofsToSend,
      amount: amount2,
  ...
  CashuWallet.prototype.splitReceive = function(amount, amountAvailable) {
    var amount1 = amountAvailable - amount;
    var amount2 = amount;
    return { amount1, amount2 };
  };
  CashuWallet.prototype.createRandomBlindedMessages = function(amount) {
    var blindedMessages = [];
    var secrets = [];
    var rs = [];
    ...
    for (var i = 0; i < amounts.length; i++) {
      ...
      secrets.push(secret);
      var _a = blindMessage(secret), B_ = _a.B_, r = _a.r;
      rs.push(r);
...
({
  m: new bnExports.BN(1e3, 10),
  u: new bnExports.BN(1e6, 10),
  n: new bnExports.BN(1e9, 10),
  p: new bnExports.BN(1e12, 10)
});
new bnExports.BN("2100000000000000000", 10);
new bnExports.BN(1e11, 10);
var TAGCODES = {
  payment_hash: 1,
  payment_secret: 16,
  description: 13,
...
function isCashuToken(token) {
  return token.startsWith("cashuA");
}
function readToken(encoded) {
...
async function saveOffer(token) {
}
